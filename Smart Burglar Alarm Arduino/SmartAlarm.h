...
{
public:
	//SmartAlarm(HouseMember users[],Maintenance maintenance[]); //Takes in 2 arrays of users, House Members and Maintenance. Maybe initialize size to avoid any issue ? 
